...
export function Notice({ title, content, buttonLabel = null, loading = null, callback = null }) {
    return (
        <div className='sticky bottom-0 p-4 bg-gradient-to-br from-indigo-500 to-violet-500 border-l-4 border-yellow-500 text-white flex items-center justify-between'>
            <div>
